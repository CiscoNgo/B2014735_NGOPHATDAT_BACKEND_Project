...
const increaseQuantity = async(req, res, next) => {
    ...
    if (checkCart) {
        ...
        const totalPrice = targetProductId.price + checkCart[0].total;
        const fillter = {
...
const decreaseQuantity = async(req, res, next) => {
    ...
    if (checkCart) {
        const quantityIncrement = -1;
        const totalPrice = -checkCart.product.product.price + checkCart.total;
...
const deleteCart = async(req, res, next) => {
    ...
    const discount = product.price * idcart;
